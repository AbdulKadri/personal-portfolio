...
const tools = [
    { logo: asset.logoHTML, name: "HTML" },
    { logo: asset.logoCSS, name: "CSS" },
    { logo: asset.logoJavaScript, name: "JavaScript" },
    { logo: asset.logoTypeScript, name: "TypeScript" },
    { logo: asset.logoReact, name: "React" },
    { logo: asset.logoRedux, name: "Redux" },
    { logo: asset.logoNextjs, name: "Next.js" },
    ...
    { logo: asset.logoWordpress, name: "Wordpress" },
    { logo: asset.logoPython, name: "Python" },
